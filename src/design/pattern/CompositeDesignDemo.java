...
public class CompositeDesignDemo {
    ...
    public static void main(String[] args) {
        ...
        TechnicalEmployee technicalEmployee1 = new TechnicalEmployee("vagish", "JVM");
        TechnicalEmployee technicalEmployee2 = new TechnicalEmployee("Gagan", "JVM");

        NonTechnicalEmployee nonTechnicalEmployee1 = new NonTechnicalEmployee("xya");
        NonTechnicalEmployee nonTechnicalEmployee2 = new NonTechnicalEmployee("abc");
